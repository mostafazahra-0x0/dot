...
-- Window manipulation
hl.bind(mainMod .. " + M", hl.dsp.exec_cmd("~/.config/hypr/scripts/minimize.sh"))
...
-- Shrink active window to a fixed small size (then move/resize freely with mouse)
hl.bind(mainMod .. " + SHIFT + Minus", function()
	hl.exec_cmd("hyprctl dispatch resizeactive exact 800 500")
end)
...
-- Shell Switcher
hl.bind(mainMod .. " + ALT + S", hl.dsp.exec_cmd("~/.local/bin/switch-shell"))

-- Screen Capture
hl.bind(mainMod .. " + P", hl.dsp.exec_cmd("hyprpicker -a -n"))
hl.bind("Print", hl.dsp.exec_cmd("~/.local/bin/screenshot.sh region"))
hl.bind(mainMod .. " + Print", hl.dsp.exec_cmd("~/.local/bin/screenshot.sh output"))
hl.bind(mainMod .. " + SHIFT + Print", hl.dsp.exec_cmd("~/.local/bin/screenshot.sh window"))
...
-- Special workspace (scratchpad / minimized windows)
